...
DLOGV1.prototype.proto_decode = function (pdu_buf) {
	...
	if (_(this).on_rcv == _(this).ON_RCV_STATES.LOG_IN_STS) {
		if ((offset_indx = pdu_buf.indexOf(">>") + 2) >= 2) {
		
			_(this).uuid = pdu_buf.slice(offset_indx, offset_indx + 8);
			
			if (_(this).login_cbk_fn(_(this).client, _(this).uuid)){				
				_(this).login_cmpt_cbk_fn(_(this).client, _(this).uuid);
				_(this).on_rcv  = _(this).ON_RCV_STATES.DATA_TRANSFER_STS;
			}
			else {
	...
	if (_(this).on_rcv == _(this).ON_RCV_STATES.DATA_TRANSFER_STS) {
